...
class Settings(BaseSettings):
    ...
    recall_candidate_count: int = Field(default=60, alias="RECALL_CANDIDATE_COUNT")
    ...
    prompt_chunk_char_limit: int = Field(default=650, alias="PROMPT_CHUNK_CHAR_LIMIT")
    prompt_max_context_chars: int = Field(default=3600, alias="PROMPT_MAX_CONTEXT_CHARS")
