...
class MinerUPdfParser:
    """对接 MinerU 服务解析 PDF，并将返回结果整理成统一页面结构。"""
    def __init__(self, settings: Settings) -> None:
        """初始化MinerU PDF 解析器所需的依赖和运行参数。"""
